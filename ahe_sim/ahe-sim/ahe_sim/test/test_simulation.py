...
class SimTest(TestCase):
    def setUp(self):
        ...
        self.device = SiteDevice.objects.get_or_create(device_type=self.device_type, ip_address='0.0.0.0', port=5232,
                                                       unit=1,
                                                       site_device_conf=self.site_device_conf, name='server_identity')[
            0]
